...
def evaluate(labels, predictions):
    ...
    sensitivity = float(positive_count / positive_overall) if positive_overall > 0 else 0
    specificity = float(negative_count / negative_overall) if negative_overall > 0 else 0
